...
#### Note: This repo exists to make sure the [Original Repo](https://github.com/binance-exchange/binance-java-api) and all its latest updates exists on the Maven Repository.
